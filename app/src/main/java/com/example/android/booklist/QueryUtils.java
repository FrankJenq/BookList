...
public final class QueryUtils {
    ...
    static List<Book> fetchEarthquakeData(String requestUrl) {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Error with require data ", e);
        }
        ...
        try {
            ...
            if (featureArray.length() > 0) {
                ...
                for (int i = 0; i < featureArray.length(); i++) {
                    ...
                    // Extract out the title, authors, categories, and infoLink.
                    books.add(new Book(volumeInfo.getString("title"), volumeInfo.getJSONArray("authors"),
                            volumeInfo.getString("description"), volumeInfo.getString("infoLink")));
                }
